...
AI sends CLI text, server parses via CliParser →?batch_execute →?results.
"""
...
def _handle_cli(args: dict) -> dict:
	...
	# Single command →?direct send (no batch overhead)
	...
	# Multi-command →?batch_execute (single TCP round-trip)
